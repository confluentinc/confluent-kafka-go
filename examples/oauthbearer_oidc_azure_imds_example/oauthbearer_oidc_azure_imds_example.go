...
// the OAUTHBEARER SASL mechanism, obtaining tokens from the
// Azure Instance Metadata Service (IMDS) metadata based authentication.
...
func main() {
	...
	consumerProperties := kafka.ConfigMap{
		"group.id":                 "oauthbearer_oidc_azure_imds_example",
