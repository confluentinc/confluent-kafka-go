...
func main() {
	...
	// Register the schema together with the encryption rule set before
	// producing. The SerializingProducer is configured to use this latest
	// registered version rather than auto-registering a new one.
