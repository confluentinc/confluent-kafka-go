// Example function-based Apache Kafka consumer
package main
...
func main() {
	...
	deser, err := avro.NewSpecificDeserializerWithStrategy(client, serde.TopicRecordNameStrategyFunc{}, avro.NewDeserializerConfig())
			...
			case *kafka.Message:
				...
				case UserFavoriteColorUpdated{}.SchemaName():
					...
					if err != nil {
						...
						fmt.Printf("%% UserFavoriteColorUpdated Message on %s:\n%+v\n", e.TopicPartition, value)
					}
				}
				if e.Headers != nil {
