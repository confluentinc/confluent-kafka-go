...
// KafkaSerializerBuilder builds the JSON Schema [Serializer] that a
...
// Build creates the JSON Schema serializer for the key or the value of a
...
// KafkaDeserializerBuilder builds the JSON Schema [Deserializer] that a
...
// Build creates the JSON Schema deserializer for the key or the value of a
