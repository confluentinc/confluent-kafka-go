...
confluent-kafka-go is based on librdkafka v2.14.1-RC1, see the
[librdkafka v2.14.1-RC1 release notes](https://github.com/confluentinc/librdkafka/releases/tag/v2.14.1-RC1)
