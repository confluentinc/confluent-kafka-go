//go:build !dynamic && !musl && !static_external
// +build !dynamic,!musl,!static_external
...
const LibrdkafkaLinkInfo = "static glibc_linux_amd64 from librdkafka-static-bundle-v2.13.2-RC1.tgz"
