//go:build !dynamic && !static_external
// +build !dynamic,!static_external
...
const LibrdkafkaLinkInfo = "static darwin_amd64 from librdkafka-static-bundle-v2.13.2-RC1.tgz"
